...
insert into TipoCliente (tipoCliente, descripcion) 
	values ('Frecuentes', 'compras con regularidad');
insert into TipoCliente (tipoCliente, descripcion) 
	values ('Ocasionales', 'compran de vez en cuando');
insert into TipoCliente (tipoCliente, descripcion) 
	values ('Nuevos', 'Sus primeras compras en el negocio');
insert into TipoCliente (tipoCliente, descripcion) 
	values ('Leales', 'muestran un compromiso constante con nosotros');
insert into TipoCliente (tipoCliente, descripcion) 
	values ('Desleales', ' cambian de negocio con frecuencia');
    
insert into TipoVehiculo(categoria, descripcion) 
	values('Categoría M1','que tengan, como máximo, ocho plazas de asiento además de la del conductor.');
insert into TipoVehiculo(categoria, descripcion) 
	values('Categoría M2','que tengan más de ocho plazas de asiento además de la del conductor y cuya masa máxima no sea superior a 5 toneladas.');
insert into TipoVehiculo(categoria, descripcion) 
	values('Categoría M3','que tengan más de ocho plazas de asiento además de la del conductor y cuya masa máxima sea superior a 5 toneladas. ');
insert into TipoVehiculo(categoria, descripcion) 
	values('Categoría N1','cuya masa máxima no sea superior a 3,5 toneladas.');
insert into TipoVehiculo(categoria, descripcion) 
	values('Categoría N2','cuya masa máxima sea superior a 3,5 toneladas pero no a 12 toneladas.');
...
select * from Empleado where usuario and DPIEmpleado;
