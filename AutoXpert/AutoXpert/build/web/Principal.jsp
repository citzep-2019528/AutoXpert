...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg nvbar-graylight bg-secondary ">
            <a class="navbar-brand" href="#">
                    <img src="img/Logo.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
            </a>
            <div class="dropdown">
                <button style="border: none" class="btn btn-outline-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"arial-haspopup="true" aria-expanded="false">
                    Vehiculos
                </button>
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                     ...
                     <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline" href="" target="myFrame">Tipo Vehiculo</a>
                     </li>
                </div>
            </div>
            <div class="dropdown">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                     <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline" href="" target="myFrame">Clientes</a>
                     </li>
                     <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline" href="" target="myFrame">TipoCliente</a>
                     </li>
                </div>
            </div>
            <div class="dropdown">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                     ...
                     <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline" href="" target="myFrame">Detalle Compras</a>
                     </li>
                </div>
            </div>
            <div class="dropdown">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                     <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline" href="" target="myFrame">DetalleCompra</a>
                     </li>
                     <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline" href="Controlador?menu=Compra&accion=Listar" target="myFrame">Detalle de Compra</a>
                     </li>
                </div>
            </div>
        ...
        <div class="m-4" style="height: 605px">
