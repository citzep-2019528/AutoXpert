...
public class Empleado {
    ...
    public Empleado(int codigoEmpleado, String DPIEmpleado, String primerNombre, String otrosNombres, String apellidos, String telefonoEmpleado, String direccionEmpleado, boolean estadoEmpleado, int codigoSucursal, int codigoTipoEmpleado) {
